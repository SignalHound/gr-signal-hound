...
#ifndef INCLUDED_SIGNAL_HOUND_SM_SERIES_H
#define INCLUDED_SIGNAL_HOUND_SM_SERIES_H
...
namespace gr {
  namespace signal_hound {
     ...
     *
     */
    class SIGNAL_HOUND_API sm_series : virtual public gr::sync_block
    {
     public:
      typedef std::shared_ptr<sm_series> sptr;

      /*!
       * \brief Return a shared_ptr to a new instance of signal_hound::sm_series.
       *
       * To avoid accidental use of raw pointers, signal_hound::sm_series's
       * constructor is in a private implementation
       * class. signal_hound::sm_series::make is the public interface for
...
#endif /* INCLUDED_SIGNAL_HOUND_SM_SERIES_H */
