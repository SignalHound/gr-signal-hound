...
#ifndef INCLUDED_SIGNAL_HOUND_SM_SERIES_IMPL_H
#define INCLUDED_SIGNAL_HOUND_SM_SERIES_IMPL_H
...
namespace gr {
    namespace signal_hound {
        class sm_series_impl : public sm_series {
            private:
                int _handle;
...
#endif /* INCLUDED_SIGNAL_HOUND_SM_SERIES_IMPL_H */
